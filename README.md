...
#### 🌍 **WorldGen & Exploração**
Larion, WWOO, Integrated Dungeons and Structures, Integrated Stronghold, Integrated Villages, TerraBlender, Paxi, Bad Wither No Cookie, Incendium, Nullscape
...
> ⚠️ Devido à quantidade de mods, configurações com menos de 12 GB RAM podem apresentar lag ou crash ao usar Distant Horizon
...
-OBS: essa distancia é o suficiente para o inicio da sua jogatina mas voce pode aumentar ela ou repetir esse metodo em um futuro caso queira ter melhor performace visual do distant horizon
...
2. Altere `options.txt` conforme necessário
3. Aplique o arquivo `crash_assistant_localization_overrides/` se precisar customizar idiomas
...
---
### iniciar novo mundo da forma correta para distant Horizon
1.
...
- 💬 [Discord All Of Create](https://discord.gg/create)
...
Encontrou um bug ou tem sugestões? Sinta-se livre para:
- Abrir uma [Issue](https://github.com/rafamendes9/God-of-Create/issues)
- Fazer um [Pull Request](https://github.com/rafamendes9/God-of-Create/pulls) - Seja detalhado e bem embasado 

---

## 🙏 Agradecimentos

- Equipe do mod **Create**, **Aeronautics** e de todos os MODDERs
- Criadores do modpack **All Of Create**
- Comunidade Neo Forge
...
- GitHub: [@rafamendes9](https://github.com/rafamendes9)
- Issues & Suporte: [Abra uma issue](https://github.com/rafamendes9/God-of-Create/issues)
